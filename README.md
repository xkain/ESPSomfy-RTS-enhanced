...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=xkain&repository=ESPSomfy-RTS-HA)


# ESPSomfy RTS-HA (Fork )
...
# Installation
The easiest way to get going is to install this integration in Home Assistant using HACS as a [Custom Repository](https://hacs.xyz/docs/faq/custom_repositories/). 

1. Go to HACS &rarr; Integrations.
2. Click the 3 dots in the top right corner and select **Custom repositories**.
3. Add the following URL: `https://github.com/xkain/ESPSomfy-RTS-HA` and select **Integration** as the category.
...
* `command`: This will be one of the following commands
  ...
  * `Down` - An down command was issued
